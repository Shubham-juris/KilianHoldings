  ...
  return (
    <div className="w-full h-[20em] bg-white flex justify-center items-center">
      <div className="w-[90%] sm:w-[60%] lg:w-[50%] flex flex-col justify-center items-center">
        <h1
          className="my-2 sm:my-3 text-[#0C3F40] text-[1.5rem] sm:text-[2rem] font-light sm:font-bold text-center relative bottom-4"
        >
          Welcome to Kilian Holdings Ltd Consulting
        </h1>
        <p
          className="my-3 text-[#747474] text-[1rem] sm:text-[1.2rem] font-light sm:font-medium text-center"
        >
          At Kilian Holdings, we understand that navigating the paralegal landscape
