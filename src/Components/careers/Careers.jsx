...
const Careers = () => {
  return (
    <Box width="100%" mx="auto" p={{ xs: 2, sm: 4, md: 6 }}>
      {/* First Job Posting */}
      <Box
        sx={{
      ...
      >
        ...
        <Box flex={1} py={{ xs: 4, sm: 6, md: 8 }} px={{ xs: 2, sm: 4, md: 8 }}>
          <Typography
            variant="h4"
            marginTop={"1em"}
            color="#2563EB"
          ...
          <Typography
            fontWeight={500}
            fontSize={"1.225rem"}
            fontFamily={"ui-sans-sarif, system-ui, sans-sarif"}
            mt={2}
            mb={1}
          >
            Job Details
          ...
          <li>
            <Typography display={"inline"} fontSize={"14px"} color={"#4b5563"}>
              Pay: $27 an hour
            </Typography>
          </li>
          <li>
          ...
          <li>
            <Typography display={"inline"} fontSize={"14px"} color={"#4b5563"}>
              Location: 4804 42 Ave, Innisfail, AB T4G 1N4, Canada
            </Typography>
          </li>
          ...
          <Typography fontSize={"14px"} color={"#4b5563"} fontWeight={600}>
            By email
          </Typography>
          <Typography
            fontSize={"14px"}
          ...
          <Typography fontSize={"14px"} color={"#4b5563"}>
            This job posting includes screening questions. Please answer the following questions
          </Typography>
          <Typography fontSize={"14px"} color={"#4b5563"}>
            when applying:
          </Typography>
