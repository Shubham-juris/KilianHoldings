...
const AboutUs = () => {
  ...
  return (
    <div>
            ...
            {aboutUs.map((item, index) => (
              <div className="p-4" key={index}>
                <img
                  src={item.image}
                  alt={item.title}
                  className="w-full h-40 md:h-60 object-cover mb-4"
                />
      ...
      <div className="flex flex-col items-center text-center px-6 py-16 md:px-20">
        <h2 className="text-lg md:text-xl font-bold text-teal-900 mb-4">
          Get in Touch
        </h2>
        <p className="text-gray-600 text-sm md:text-base font-semibold max-w-2xl mb-6">
        ...
        <button className="text-sm font-semibold text-gray-900 underline hover:text-teal-700 transition">
          FIND OUT MORE
        </button>
      </div>
    </div>
